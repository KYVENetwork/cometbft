...
func TestWriteFileAtomic(t *testing.T) {
	...
	f, err := os.CreateTemp("/tmp", "write-atomic-test-2-")
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteFileAtomicDuplicateFile(t *testing.T) {
	var (
		...
		testString            = "This is a glorious test-2 string"
		expectedString        = "Did the test-2 file's string appear here?"

		fileToWrite = "/tmp/TestWriteFileAtomicDuplicateFile-test-2.txt"
	)
...
func TestWriteFileAtomicManyDuplicates(t *testing.T) {
	var (
		...
		testString            = "This is a glorious test-2 string, from file %d"
		expectedString        = "Did any of the test-2 file's string appear here?"
