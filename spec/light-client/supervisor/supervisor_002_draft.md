...
Types](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/types/genesis.go).
...
[light client attack](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/spec/light-client/detection/detection_003_reviewed.md#cmbc-lc-attack1)
and not just a [bogus](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/spec/light-client/detection/detection_003_reviewed.md#cmbc-bogus1) block could result in
