...
in the node [initialization](https://github.com/KYVENetwork/cometbft/v38/blob/v0.34.x/node/node.go#L563).

This method is called when a node is [started](https://github.com/KYVENetwork/cometbft/v38/blob/v0.34.x/node/node.go#L974).
...
This method is called when a node is [stopped](https://github.com/KYVENetwork/cometbft/v38/blob/v0.34.x/node/node.go#L1023).
