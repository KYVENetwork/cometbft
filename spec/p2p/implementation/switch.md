...
- In the [setup](https://github.com/KYVENetwork/cometbft/v38/blob/v0.34.x/node/node.go#L987)
...
- In the RPC package, to implement two unsafe RPC commands, not used in production:
  [`DialSeeds`](https://github.com/KYVENetwork/cometbft/v38/blob/v0.34.x/rpc/core/net.go#L47) and
  [`DialPeers`](https://github.com/KYVENetwork/cometbft/v38/blob/v0.34.x/rpc/core/net.go#L87)
