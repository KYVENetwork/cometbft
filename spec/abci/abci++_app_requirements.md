...
[default in-process ABCI client](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/abci/client/local_client.go#L13)
and the
[default Go ABCI server](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/abci/server/socket_server.go#L20)
...
to switch are met [RFC-100](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/docs/rfc/rfc-100-abci-vote-extension-propag.md#base-implementation-persist-and-propagate-extended-commit-history).
...
[section](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/docs/rfc/rfc-100-abci-vote-extension-propag.md#upgrade-path) in RFC-100.
