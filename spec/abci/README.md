...
All ABCI++ messages and methods are defined in [protocol buffers](https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/proto/tendermint/abci/types.proto).
