...
| Data       | [Data](#data)                  | Data contains a list of transactions. The contents of the transaction is unknown to CometBFT.                                                                                      | This field can be empty or populated, but no validation is performed. Applications can perform validation on individual transactions prior to block creation using [checkTx](https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/spec/abci/abci%2B%2B_methods.md#checktx).
...
| App   | uint64 | App version is decided on by the application. Read [here](https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/spec/abci/abci++_app_requirements.md)                                 | `block.Version.App == state.Version.Consensus.App`                                                                 |
...
(see [ADR-25](https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/docs/architecture/adr-025-commit.md)).
