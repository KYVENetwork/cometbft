...
// This test-2 was quite hacky because it relies on SetFinalizer
...
// This test-2 is quite hacky because it relies on SetFinalizer
...
func TestWaitChan(t *testing.T) {
	...
	// 3) test-2 iterating forward and waiting for Next (NextWaitChan and Next)
	el = l.PushBack(0)
...
FOR_LOOP:
	...
	// 4) test-2 iterating backwards (PrevWaitChan and Prev)
	prev := next
	seen = 0
FOR_LOOP2:
	for {
