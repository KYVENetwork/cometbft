...
* Here are some common library labels for consistency:
    ...
    * cmtcmd "github.com/KYVENetwork/cometbft/v38/cmd/cometbft/commands"
    * cmtcfg "github.com/KYVENetwork/cometbft/v38/config"
    * cmttypes "github.com/KYVENetwork/cometbft/v38/types"
...
* When importing a pkg from the `cmt/libs` directory, prefix the pkg alias with cmt.
    * cmtbits "github.com/KYVENetwork/cometbft/v38/libs/bits"
