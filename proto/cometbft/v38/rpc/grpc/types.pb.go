...
// source: cometbft/v38/rpc/grpc/types.proto
...
func (*RequestPing) Descriptor() ([]byte, []int) {
	return fileDescriptor_96a066730637149c, []int{0}
}
...
func (*RequestBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_96a066730637149c, []int{1}
}
...
func (*ResponsePing) Descriptor() ([]byte, []int) {
	return fileDescriptor_96a066730637149c, []int{2}
}
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_96a066730637149c, []int{3}
}
...
func init() {
	proto.RegisterType((*RequestPing)(nil), "cometbft.v38.rpc.grpc.RequestPing")
	proto.RegisterType((*RequestBroadcastTx)(nil), "cometbft.v38.rpc.grpc.RequestBroadcastTx")
	proto.RegisterType((*ResponsePing)(nil), "cometbft.v38.rpc.grpc.ResponsePing")
	proto.RegisterType((*ResponseBroadcastTx)(nil), "cometbft.v38.rpc.grpc.ResponseBroadcastTx")
}

func init() { proto.RegisterFile("cometbft/v38/rpc/grpc/types.proto", fileDescriptor_96a066730637149c) }

var fileDescriptor_96a066730637149c = []byte{
	// 334 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x4c, 0xce, 0xcf, 0x4d,
	0x2d, 0x49, 0x4a, 0x2b, 0xd1, 0x2f, 0x33, 0xb6, 0xd0, 0x2f, 0x2a, 0x48, 0xd6, 0x4f, 0x07, 0x11,
	0x25, 0x95, 0x05, 0xa9, 0xc5, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0xa2, 0x30, 0x25, 0x7a,
	0x65, 0xc6, 0x16, 0x7a, 0x45, 0x05, 0xc9, 0x7a, 0x20, 0x25, 0x52, 0xb2, 0x28, 0x3a, 0x13, 0x93,
	...
	,
	...
	0x46, 0x69, 0x12, 0xc8, 0x2c, 0x7d, 0xef, 0xc8, 0x30, 0x57, 0xbf, 0xd4, 0x92, 0xf2, 0xfc, 0xa2,
	0x6c, 0x7d, 0xac, 0x69, 0xc5, 0x3a, 0x39, 0xbf, 0x28, 0x15, 0xc4, 0x48, 0x62, 0x03, 0xc7, 0xbc,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xad, 0x54, 0x8a, 0x58, 0x54, 0x02, 0x00, 0x00,
}
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *RequestPing, opts ...grpc.CallOption) (*ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.v38.rpc.grpc.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.v38.rpc.grpc.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.v38.rpc.grpc.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.v38.rpc.grpc.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cometbft.v38.rpc.grpc.BroadcastAPI",
	...
	Metadata: "cometbft/v38/rpc/grpc/types.proto",
}
