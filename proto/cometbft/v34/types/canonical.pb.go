...
// source: cometbft/v34/types/canonical.proto
...
func (*CanonicalBlockID) Descriptor() ([]byte, []int) {
	return fileDescriptor_3eac00eeca0fb1b0, []int{0}
}
...
func (*CanonicalPartSetHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_3eac00eeca0fb1b0, []int{1}
}
...
func (*CanonicalProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_3eac00eeca0fb1b0, []int{2}
}
...
func (*CanonicalVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_3eac00eeca0fb1b0, []int{3}
}
...
func init() {
	proto.RegisterType((*CanonicalBlockID)(nil), "cometbft.v34.types.CanonicalBlockID")
	proto.RegisterType((*CanonicalPartSetHeader)(nil), "cometbft.v34.types.CanonicalPartSetHeader")
	proto.RegisterType((*CanonicalProposal)(nil), "cometbft.v34.types.CanonicalProposal")
	proto.RegisterType((*CanonicalVote)(nil), "cometbft.v34.types.CanonicalVote")
}

func init() {
	proto.RegisterFile("cometbft/v34/types/canonical.proto", fileDescriptor_3eac00eeca0fb1b0)
}

var fileDescriptor_3eac00eeca0fb1b0 = []byte{
	// 507 bytes of a gzipped FileDescriptorProto
	,
}
