...
import (
	...
	abciclimocks "github.com/KYVENetwork/cometbft/v1/abci/client/mocks"
	"github.com/KYVENetwork/cometbft/v1/abci/example/kvstore"
	abciserver "github.com/KYVENetwork/cometbft/v1/abci/server"
...
// This test used to cause a data race when rechecking (see https://github.com/KYVENetwork/cometbft/v1/issues/1827).
