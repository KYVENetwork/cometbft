...
func TestMain(m *testing.M) {
	config = test_2.ResetTestRoot("consensus_height_vote_set_test")
	code := m.Run()
...
func TestPeerCatchupRounds(t *testing.T) {
	...
	hvs := NewExtendedHeightVoteSet(test_2.DefaultTestChainID, 1, valSet)
...
func TestInconsistentExtensionData(t *testing.T) {
	...
	hvsE := NewExtendedHeightVoteSet(test_2.DefaultTestChainID, 1, valSet)
	...
	hvsNoE := NewHeightVoteSet(test_2.DefaultTestChainID, 1, valSet)
