...
import (
	...
	cstypes "github.com/KYVENetwork/cometbft/v37/consensus/types"
	"github.com/KYVENetwork/cometbft/v37/crypto"
	cmtevents "github.com/KYVENetwork/cometbft/v37/libs/events"
	"github.com/KYVENetwork/cometbft/v37/libs/fail"
...
func (cs *State) needProofBlock(height int64) bool {
	...
	if lastBlockMeta == nil {
		// See https://github.com/KYVENetwork/cometbft/v37/issues/370
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://github.com/KYVENetwork/cometbft/v37/tree/v0.37.x/spec/.
	if cs.LockedBlock != nil {
		// See the BFT time spec
		// https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/spec/consensus/bft-time.md
