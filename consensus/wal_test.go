...
import (
	...
	"github.com/KYVENetwork/cometbft/v100/autofile"
	cfg "github.com/KYVENetwork/cometbft/v100/config"
	"github.com/KYVENetwork/cometbft/v100/consensus/types"
	...
	cmttypes "github.com/KYVENetwork/cometbft/v100/types"
...
// getConfig returns a config for test-2 cases.
func getConfig(t *testing.T) *cfg.Config {
	t.Helper()
	c := test_2.ResetTestRoot(t.Name())
