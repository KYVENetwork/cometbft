...
func TestNoBlockResponse(t *testing.T) {
	config = test_2.ResetTestRoot("blocksync_reactor_test")
...
// NOTE: This is too hard to test-2 without
// an easy way to add test-2 peer to switch
...
func TestBadBlockStopsPeer(t *testing.T) {
	...
	reactorPairs = append(reactorPairs, lastReactorPair) //nolint:makezero // when initializing with 0, the test-2 breaks.
