...
// - header.Hash()
// - abci.Header
// - https://github.com/KYVENetwork/cometbft/v1/blob/main/spec/blockchain/blockchain.md
type Header struct {
	// basic block info
...
// See: https://github.com/KYVENetwork/cometbft/v1/blob/main/spec/consensus/bft-time.md
