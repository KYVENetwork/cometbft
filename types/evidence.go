...
func init() {
	cmtjson.RegisterType(&DuplicateVoteEvidence{}, "cometbft/DuplicateVoteEvidence")
	cmtjson.RegisterType(&LightClientAttackEvidence{}, "cometbft/LightClientAttackEvidence")
}
