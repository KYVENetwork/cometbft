...
func init() {
	cmtjson.RegisterType(&DuplicateVoteEvidence{}, "cometbft/v34/DuplicateVoteEvidence")
	cmtjson.RegisterType(&LightClientAttackEvidence{}, "cometbft/v34/LightClientAttackEvidence")
}
