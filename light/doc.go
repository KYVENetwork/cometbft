...
https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/spec/light-client/verification/README.md
for details.
...
for usage example.
Or see
https://github.com/KYVENetwork/cometbft/v37/tree/v0.37.x/spec/consensus/light-client
for the full spec
*/
package light
