...
https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/spec/light-client/verification/README.md
for details.
...
for usage example.
Or see
https://github.com/KYVENetwork/cometbft/v38/tree/v0.38.x/spec/consensus/light-client
for the full spec
*/
package light
