...
See our [light
package](https://pkg.go.dev/github.com/KYVENetwork/cometbft/v38/light?tab=doc).
...
[merkle proofs](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/spec/core/encoding.md#iavl-tree).
...
[Trust Options](https://pkg.go.dev/github.com/KYVENetwork/cometbft/v38/light?tab=doc#TrustOptions)
