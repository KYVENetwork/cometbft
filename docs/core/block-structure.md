...
[data_structures]: https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/spec/core/data_structures.md
[types]: https://pkg.go.dev/github.com/KYVENetwork/cometbft/v37/types
