...
issue](https://github.com/KYVENetwork/cometbft/v37/issues) already.
...
is [valid and within allowed ranges](https://github.com/KYVENetwork/cometbft/v37/blob/v0.37.x/p2p/netaddress.go#L258).
