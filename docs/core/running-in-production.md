...
issue](https://github.com/KYVENetwork/cometbft/v38/issues) already.
...
is [valid and within allowed ranges](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/p2p/netaddress.go#L258).
