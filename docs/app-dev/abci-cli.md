...
code can be found
[here](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/abci/example/kvstore/kvstore.go).
...
Golang](https://github.com/KYVENetwork/cometbft/v38/tree/v0.38.x/abci/server). See the
