...
[releases]: https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/RELEASES.md#large-scale-testnets
...
2. To identify saturation points
   1. Extract the latency report for all the experiments.
       ...
       * ```bash
         mkdir results
         go run github.com/KYVENetwork/cometbft/v38/test/loadtime/cmd/report@3003ef7 --database-type goleveldb --data-dir ./ > results/report.txt
         ```
...
3. To generate a latency vs throughput plot, extract the data as a CSV
    * ```bash
       go run github.com/KYVENetwork/cometbft/v38/test/loadtime/cmd/report@3003ef7 --database-type goleveldb --data-dir ./ --csv results/raw.csv
       ```
...
[`latency_throughput.py`]: https://github.com/KYVENetwork/cometbft/v38/tree/v0.38.x/scripts/qa/reporting#latency-vs-throughput-plotting
[`latency_plotter.py`]: https://github.com/KYVENetwork/cometbft/v38/tree/v0.38.x/scripts/qa/reporting#latency-vs-throughput-plotting-version-2
...
[`prometheus_plotter.py`]: https://github.com/KYVENetwork/cometbft/v38/tree/v0.38.x/scripts/qa/reporting#prometheus-metrics
