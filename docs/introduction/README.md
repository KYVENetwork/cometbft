...
(ABCI)](https://github.com/KYVENetwork/cometbft/v37/tree/main/abci)
...
Types](https://github.com/KYVENetwork/cometbft/v37/blob/main/proto/tendermint/abci/types.proto).
