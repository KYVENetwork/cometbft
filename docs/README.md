...
To learn about application development on CometBFT, see the [Application Blockchain Interface](https://github.com/KYVENetwork/cometbft/v38/tree/v0.38.x/spec/abci).
