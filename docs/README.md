...
To learn about application development on CometBFT, see the [Application Blockchain Interface](https://github.com/KYVENetwork/cometbft/v37/tree/v0.37.x/spec/abci).
