...
To use your own ABCI applications with 4-node setup edit the [docker-compose.yaml](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/docker-compose.yml) file and add images to your ABCI application.
...
Override the [command](https://github.com/KYVENetwork/cometbft/v38/blob/v0.38.x/networks/local/localnode/Dockerfile#L11) in each node to connect to it's ABCI.
