...
// source: cometbft/v100/rpc/grpc/v1beta3/types.proto
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4029eacde36daa9, []int{0}
}
...
func init() {
	proto.RegisterType((*ResponseBroadcastTx)(nil), "cometbft.v100.rpc.grpc.v1beta3.ResponseBroadcastTx")
}

func init() {
	proto.RegisterFile("cometbft/v100/rpc/grpc/v1beta3/types.proto", fileDescriptor_f4029eacde36daa9)
}

var fileDescriptor_f4029eacde36daa9 = []byte{
	...
	,
}
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *v1beta1.RequestPing, opts ...grpc.CallOption) (*v1beta1.ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.v100.rpc.grpc.v1beta3.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *v1beta1.RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.v100.rpc.grpc.v1beta3.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.v100.rpc.grpc.v1beta3.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.v100.rpc.grpc.v1beta3.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cometbft.v100.rpc.grpc.v1beta3.BroadcastAPI",
	...
	Metadata: "cometbft/v100/rpc/grpc/v1beta3/types.proto",
}
