...
// source: cometbft/v100/rpc/grpc/v1beta2/types.proto
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_38e067ea35f74e60, []int{0}
}
...
func init() {
	proto.RegisterType((*ResponseBroadcastTx)(nil), "cometbft.v100.rpc.grpc.v1beta2.ResponseBroadcastTx")
}

func init() {
	proto.RegisterFile("cometbft/v100/rpc/grpc/v1beta2/types.proto", fileDescriptor_38e067ea35f74e60)
}

var fileDescriptor_38e067ea35f74e60 = []byte{
	...
	0x11, 0x65, 0x86, 0x49, 0xa9, 0x25, 0x89, 0x46, 0xfa, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x7a, 0x05,
	...
	0x62, 0x52, 0x72, 0x26, 0x36, 0x3b, 0x95, 0x56, 0x33, 0x72, 0x09, 0x07, 0xa5, 0x16, 0x17, 0xe4,
	...
	,
}
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *v1beta1.RequestPing, opts ...grpc.CallOption) (*v1beta1.ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.v100.rpc.grpc.v1beta2.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *v1beta1.RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.v100.rpc.grpc.v1beta2.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.v100.rpc.grpc.v1beta2.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.v100.rpc.grpc.v1beta2.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cometbft.v100.rpc.grpc.v1beta2.BroadcastAPI",
	...
	Metadata: "cometbft/v100/rpc/grpc/v1beta2/types.proto",
}
