...
import (
	...
	pbpruningsvc "github.com/KYVENetwork/cometbft/v1/api/cometbft/services/pruning/v1"
	"github.com/KYVENetwork/cometbft/v1/libs/log"
	"github.com/KYVENetwork/cometbft/v1/rpc/grpc/server/services/pruningservice"
